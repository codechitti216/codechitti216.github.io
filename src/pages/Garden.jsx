...
const Garden = () => {
  ...
  const filteredEntries = gardenData.filter(entry => {
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-lg text-gray-700 leading-relaxed">
          A digital garden of evolving thoughts, research insights, and technical observations. 
          These notes represent my ongoing learning journey—some ideas are mature, others are still growing.
        </p>
      </div>
